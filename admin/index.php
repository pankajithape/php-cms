      ...
      <script type="text/javascript">
        ...
        function drawChart() {
          var data = google.visualization.arrayToDataTable([
            ...
            $element_count = [$post_counts, $post_published_counts, $post_draft_counts, $comments_counts, $comments_unapproved_counts,  $user_counts, $subscriber_counts,  $categories_counts];
