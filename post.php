...
if (isset($_POST['liked'])) {
  ...
  // 3. insert likes for post
  mysqli_query($connection, "INSERT INTO likes(user_id, post_id) VALUES($user_id, $post_id)");
}
if (isset($_POST['unliked'])) {
  // echo "<h1>UNLIKE WORKS</h1>";
  $post_id = $_POST['post_id'];
  $user_id = $_POST['user_id'];
  // 1. FETCHING RIGHT POST
  $query = "SELECT * FROM posts WHERE post_id=$post_id";
    ...
    <div class="col-md-8">
      ...
      <div class="row">
        <p class="pull-right"><a class="<?php echo userLikedThisPost($the_post_id) ? 'unlike' : 'like'; ?>"
            style="font-size: 20px;" href=""><span class="glyphicon glyphicon-thumbs-up" data-toggle="tooltip"
              data-placement="top"
              title="<?php echo userLikedThisPost($the_post_id) ? 'I liked this before' : 'Want to like it?'; ?>"></span><?php echo userLikedThisPost($the_post_id) ? " Unlike" : " like"; ?></a>
        </p>
      </div>
